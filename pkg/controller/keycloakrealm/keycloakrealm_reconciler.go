...
func (i *KeycloakRealmReconciler) ReconcileRealmCreate(state *common.RealmState, cr *kc.KeycloakRealm) common.DesiredClusterState {
	...
	desired.AddAction(i.getDesiredKeycloakOperatorCLIClientState(state, cr))
...
func (i *KeycloakRealmReconciler) getDesiredKeycloakOperatorCLIClientState(state *common.RealmState, cr *kc.KeycloakRealm) common.ClusterAction {
	keycloakOperatorCLIClient := model.KeycloakOperatorCLIClient(cr)
	if state.KeycloakCLIClient == nil {
		return &common.GenericCreateAction{
			Ref: keycloakOperatorCLIClient,
			Msg: "Create Keycloak Operator CLI Client",
		}
	}
	return &common.GenericUpdateAction{
		Ref: model.KeycloakOperatorCLIClientReconciled(cr, state.KeycloakCLIClient),
		Msg: "Update Keycloak Operator CLI Client",
	}
}
