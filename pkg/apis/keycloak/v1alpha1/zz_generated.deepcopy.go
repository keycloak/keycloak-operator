...
func (in *KeycloakClientSpec) DeepCopyInto(out *KeycloakClientSpec) {
	*out = *in
	...
	in.ServiceAccountRoles.DeepCopyInto(&out.ServiceAccountRoles)
	return
}
...
func (in *KeycloakClientStatus) DeepCopyInto(out *KeycloakClientStatus) {
	*out = *in
	...
	if in.RealmClientIds != nil {
		in, out := &in.RealmClientIds, &out.RealmClientIds
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.RealmServiceAccountIds != nil {
		in, out := &in.RealmServiceAccountIds, &out.RealmServiceAccountIds
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeycloakServiceAccountRoles) DeepCopyInto(out *KeycloakServiceAccountRoles) {
	*out = *in
	if in.RealmRoles != nil {
		in, out := &in.RealmRoles, &out.RealmRoles
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeycloakServiceAccountRoles.
func (in *KeycloakServiceAccountRoles) DeepCopy() *KeycloakServiceAccountRoles {
	if in == nil {
		return nil
	}
	out := new(KeycloakServiceAccountRoles)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeycloakUserStatus) DeepCopyInto(out *KeycloakUserStatus) {
	*out = *in
	if in.RealmUserIds != nil {
		in, out := &in.RealmUserIds, &out.RealmUserIds
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
