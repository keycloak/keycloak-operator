	...
	return &keycloakv1alpha1.KeycloakRealm{
		...
		Spec: keycloakv1alpha1.KeycloakRealmSpec{
			...
			Realm: &keycloakv1alpha1.KeycloakAPIRealm{
				...
				WebAuthnPolicyAcceptableAaguids: []string{"policy"},
				WebAuthnPolicyAttestationConveyancePreference:             "keycloak",
				WebAuthnPolicyAuthenticatorAttachment:                     "keycloak",
				WebAuthnPolicyAvoidSameAuthenticatorRegister:              &[]bool{true}[0],
				WebAuthnPolicyCreateTimeout:                               &[]int32{60}[0],
				WebAuthnPolicyPasswordlessAcceptableAaguids:               []string{"policy"},
				WebAuthnPolicyPasswordlessAttestationConveyancePreference: "keycloak",
				WebAuthnPolicyPasswordlessAuthenticatorAttachment:         "keycloak",
				WebAuthnPolicyPasswordlessAvoidSameAuthenticatorRegister:  &[]bool{true}[0],
				WebAuthnPolicyPasswordlessCreateTimeout:                   &[]int32{60}[0],
				WebAuthnPolicyPasswordlessRequireResidentKey:              "keycloak",
				WebAuthnPolicyPasswordlessRpEntityName:                    "keycloak",
				WebAuthnPolicyPasswordlessRpID:                            "keycloak",
				WebAuthnPolicyPasswordlessSignatureAlgorithms:             []string{"policy"},
				WebAuthnPolicyPasswordlessUserVerificationRequirement:     "keycloak",
				WebAuthnPolicyRequireResidentKey:                          "keycloak",
				WebAuthnPolicyRpEntityName:                                "keycloak",
				WebAuthnPolicyRpID:                                        "keycloak",
				WebAuthnPolicySignatureAlgorithms:                         []string{"policy"},
				WebAuthnPolicyUserVerificationRequirement:                 "keycloak",
			},
		},
	}
}
