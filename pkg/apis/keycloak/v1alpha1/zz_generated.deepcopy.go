...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServingCertSecretName) DeepCopyInto(out *ServingCertSecretName) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServingCertSecretName.
func (in *ServingCertSecretName) DeepCopy() *ServingCertSecretName {
	if in == nil {
		return nil
	}
	out := new(ServingCertSecretName)
	in.DeepCopyInto(out)
	return out
}
